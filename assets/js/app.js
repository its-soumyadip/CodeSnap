...
// Get the base URL, excluding the protocol and domain for hosting

// Get the base URL, excluding the protocol and domain
const basePath = window.location.pathname.split("/")[1];

// Determine the correct href for the Home link
const homeHref = basePath ? `/${basePath}/` : "/";

// Set the href attribute for the Home link
document.getElementById("home-link").setAttribute("href", homeHref);
